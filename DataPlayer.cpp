...
// Setters
void DataPlayer::setPosicion(int pos) { posicion = pos; }
void DataPlayer::setNombre(const char* name) { strcpy(nombre, name); }
void DataPlayer::setPuntaje(int p) { puntaje = p; }
